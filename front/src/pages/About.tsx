...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Our best Random Forest reaches ~66% TimeSeriesSplit CV accuracy on the historical dataset — versus a 55.6% always-pick-home baseline and a Vegas-line ceiling around 67–68%. Actual performance depends on data recency and feature quality.",
  },
  {
    question: "Which machine learning models are available?",
    answer:
      "Currently the system supports Decision Tree, Random Forest, XGBoost, and a most-frequent Baseline. Random Forest is the default recommendation for accuracy; Decision Tree is the most interpretable. Neural Networks are coming soon.",
  },
  {
